...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            # Step 2: Trigger the scheduled scraping task
            self.stdout.write("Starting scheduled scraping...")
            logger.info("Triggering the Celery task: scheduled_scraping.")
            scheduled_scraping.delay()  # Use .delay() to run the Celery task asynchronously
            ...
            self.stdout.write("Scheduled scraping completed. Verifying results...")
            logger.info("Verifying results of the scheduled scraping.")
